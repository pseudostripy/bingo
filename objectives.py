objectives = [
    ...
    {"name": "have at least one of each arrow type in your inventory"},
    {"name": "have at least one of each great arrow type in your inventory"},
    {"name": "have at least one of each bolt type in your inventory"},
    ...
    {"name": "obtain Benhart's armour",         "level": "easy"},
    ...
    {"name": "obtain Dragonslayer Greatbow"},
    {"name": "obtain chaos blade"},
    {"name": "obtain Crypt Blacksword"},
