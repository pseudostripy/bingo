objectives = [
    ...
    {"name": "only starting gear (not including rings)", "level": "expert", "props": "predrangleic"},
    {"name": "get clear bluestone ring +0, +1, and +2", "level": "medium", "props": "predrangleic"},
    {"name": "get chloranthy ring +0, +1, and +2",      "level": "medium", "props": "predrangleic"},
    {"name": "get life ring +0, +1, +2, and +3",    "level": "hard"},
