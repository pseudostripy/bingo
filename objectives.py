objectives = [
    ...
    {"name": "don't wear damage rings", "level": "expert", "props": "predrangleic"},
    # kill
    ...
    {"name": "obtain both pyromancy flames",    "level": "medium", "props": "predrangleic"},
    ...
    {"name": "obtain the Dragonslayer Greatbow",    "level": "easy", "props": "predrangleic"},
    {"name": "obtain the chaos blade",              "level": "easy", "props": "predrangleic"},
    {"name": "obtain the Crypt Blacksword",         "level": "easy", "props": "predrangleic"},
    {"name": "obtain the Chime of Screams",         "level": "expert"},
    {"name": "obtain the Moonlight Greatsword",     "level": "hard", "props": "predrangleic"},
